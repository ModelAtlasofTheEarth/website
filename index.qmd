...
<img src="images/AuScopeLogo.webp" alt="AuScopeLogo" style="height:40px; vertical-alingn:middle;" />
  ...
  <br/>
  <br/>
  <a href="generated/models/index.html" class="btn btn-primary" style="background:#D64000; border-color:#D64000; font-size:18px; padding:0.5rem 1.5rem;">
    Browse Models
  </a>
  &nbsp;
...
<div style="text-align:center; margin-top:1.5rem;">
  <a href="generated/models/index.html" class="btn btn-outline-primary" style="border-color:#D64000; color:#D64000;">
    View all models →
  </a>
</div>
```
